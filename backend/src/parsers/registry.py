...
def get_parser_for(filename: str) -> Parser:
    ...
    Raises UnsupportedFileTypeError when nothing can handle it. Note that
    DocumentService.ALLOWED_EXTENSIONS is deliberately wider than this — a user
    may upload an image, it just cannot be ingested for search yet.
    """
